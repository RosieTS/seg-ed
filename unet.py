...
This code comes from the depreciated:
...
class UNet(nn.Module):
    ...
    num_layers : int, optional
        Number of layers in each side of U-net (default 5).
    features_start : int, optional
        Number of features in first layer (default 64).
    bilinear: bool, optional
        Whether to use bilinear interpolation or transposed convolutions
        (default False).
